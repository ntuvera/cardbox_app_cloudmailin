...
Fill in the subject with the Name of your subject and add a memo about the subject in the body of of yoru text.  

[insert screen shot of text fields]


Card_Box_ will receive and process your email and be ready for when you sign on to manage cards and create conacts.


[saved contacts screen shot]
...
[insert screen shot of map with marked lcoations]
